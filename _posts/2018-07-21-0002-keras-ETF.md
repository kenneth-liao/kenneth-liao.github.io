...
## Objective
I will build a simple neural network model to forecast future stock market prices.

## Background

![ETF Sectors]({{ "/images/0002-keras-ETF/keras-NN-sectors.png" | absolute_url }})

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Data for over 700 stocks was compiled from Yahoo finance. To narrow the scope of the model, the stocks were grouped into 6 sectors
