...
## Objective
I created a simple neural network (NN) using the [Keras](https://keras.io/) API. The NN was trained to predict future exchange traded fund (ETF) prices based on economic indicators.
...
<details>
  <summary>Economic indicator descriptions. </summary><p>
...
<details>
  <summary>Remaining 5 sector ETF predictions. </summary><p>
  <script src="https://cdn.plot.ly/plotly-latest.min.js"></script>
...
<details>
  <summary>Remaining 9 indicator dependence plots. </summary><p>
  <script src="https://cdn.plot.ly/plotly-latest.min.js"></script>
