...
excerpt: "Forecasting based on economic indicators"
mathjax: "true"
...
<img style=" margin: 30px auto; display: block;" height="Auto" width = "Auto" src="/images/0002-keras-ETF/sectorETF-learningcurves.html">

</div></div>

# Objective
I created a simple neural network (NN) using the [Keras](https://keras.io/) API. The NN was trained to predict future exchange traded fund (ETF) prices based on economic indicators. In part 1 of this series, I want to explore whether forecasting the stock market using economic indicators is a viable strategy. Subsequent studies will include tuning hyperparameters, trying different NN architectures, and a comparison to other methods such as time series forecasting.
...
#### Figure 7 | Technology ETF vs Indicators
<script src="https://cdn.plot.ly/plotly-latest.min.js"></script>
