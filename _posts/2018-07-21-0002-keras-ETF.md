...
![ETF Sectors]({{ "/images/0002-keras-ETF/keras-NN-sectors.png" | absolute_url }})
...
<div id="c0a7e4b4-e54f-4bff-934f-b41c1d1beb50" style="height: 100%; width: 100%;" class="plotly-graph-div"></div><script type="text/javascript">window.PLOTLYENV=window.PLOTLYENV || {};window.PLOTLYENV.BASE_URL="https://plot.ly";Plotly.newPlot("c0a7e4b4-e54f-4bff-934f-b41c1d1beb50", [{"x": [1, 2, 3, 4], "y": [4, 3, 2, 1], "type": "scatter", "uid": "8297ee8a-9156-11e8-b0b3-e442a6f8adc6"}], {"title": "hello world"}, {"showLink": true, "linkText": "Export to plot.ly"})</script>
