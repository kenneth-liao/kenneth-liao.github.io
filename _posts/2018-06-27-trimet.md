...
## Summary
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; I explored vehicle delay data from TriMet's MAX Light Rail system spanning *January* 2017 to *June* 2017 and answered the questions below. These insights provide a good starting point for understanding where the biggest impacts can be made in TriMet's MAX Light Rail system to reduce vehicle delay and improve on-time performance.
